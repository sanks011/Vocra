  ...
  const navigate = useNavigate();
    ...
    <div className="min-h-screen bg-black">
      <HeroSection
        ...
        ctaText={isAuthenticated ? "Get Started" : "Start Free Trial"}
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col gap-12 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="w-full lg:w-3/5">
              ...
              <p className="text-gray-300 lg:text-xl mb-8 max-w-2xl">
              ...
              </p>              <div className="flex flex-col gap-4 sm:flex-row">
                <Button asChild size="lg" className="bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-lg">
                  <a href={isAuthenticated ? "/dashboard" : "/login"}>{isAuthenticated ? "Get Started" : "Start Free Trial"}</a>
                </Button>
